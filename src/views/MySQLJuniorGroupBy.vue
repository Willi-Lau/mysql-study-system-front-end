...
/* 公共部分 */
      ...
      .MySQLJuniorGroupBy .homeBottom1{
            position: relative;
            top: 1850px;
        ...
        .MySQLJuniorGroupBy .homeBottom1 .text{
          position: relative;
          top: 40px;
   ...
   .MySQLJuniorGroupBy .mysql-change-1{
      position: absolute;
      left: 300px;
      top: 100px;
      right: 200px;
